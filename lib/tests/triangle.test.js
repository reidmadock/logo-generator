...
// A test is created to check the trimmed result of render().
    describe('renderTextEl', () => {
        it('Should output correct offset for textEl', () => {
            const result = ` <text x="150" y="130" text-anchor="middle" style="dominant-baseline:middle;font:60px serif;fill:white">
            APM
        </text>`
    ...
    describe('render', () => {
        it('Should output a viable .svg string', () => {
            ...
            <svg width="300" height="200">
                <polyline points="150 0 25 200 275 200 150 0" stroke="none" fill="#f5428d"/>
                
            <text x="150" y="130" text-anchor="middle" style="dominant-baseline:middle;font:60px serif;fill:#42f5d4">
                RTM
            </text>
            </svg>`;
            const inputs = ['RTM','#42f5d4','#f5428d'];
            const triangle = new Triangle(inputs[0],inputs[1],inputs[2]);
